...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo14.png" alt=""> </a>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="https://images.ctfassets.net/2x1b56neok6m/uk-media-3398-asset/7c6e269ad56491cc2db9f8c7fea9914f/shutterstock_594029531-2.jpg?w=1216&q=50">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Now</h1>
                    <h5 class="font-white space-xs">Order food online from the best restaurants</h5>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/logo13.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> </div>
