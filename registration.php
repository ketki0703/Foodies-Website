...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	{
		$message = "invalid phone number! Number is less than 10 digits";
	}
   elseif(strlen($_POST['phone']) > 10 )  //cal phone length
	{
		$message = "invalid phone number! Number is greater than 10 digits";
	}
         ...
         <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
               <div class="container">
                  ...
                  <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logo13.png" alt=""> </a>
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder="Phone"> <small class="form-text text-muted">We"ll never share your Number with anyone else.</small> 
                                    </div>
                                    <div class="form-group col-sm-6">
               ...
               <div class="container">
                  ...
                  <div class="row top-footer">
                     <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/logo13.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Take-Out </span> 
                     </div>
                     ...
                     <div class="col-xs-12 col-sm-2 address color-gray">
                            <!-- <h5>Address</h5>
                            <p>Concept design of oline food order and deliveye,planned as restaurant directory</p> -->
                            <h5>Helpline Number: <br><br><a href="tel:+080000012222">9875463210</a></h5> </div>
                    <div class="col-xs-12 col-sm-2 payment-options color-gray">
