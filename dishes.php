        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="images/logo13.png" alt=""> </a>
        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="https://img.lovepik.com/photo/50127/6564.jpg_wh300.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >₹<?php echo $product['price']; ?></span>
										  <input class="b-r-10" type="text" name="quantity"  style="margin-left:30px;" value="1" size="2" />
                                          <br>
                                          <br>
